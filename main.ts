    ...
    if (Level == 1) {
        ...
        if (extra) {
            ...
            game.setDialogFrame(img`
                ...
                f f f f f f f f f f f f f f f f 
                `)
            game.showLongText("Invalid Level :(", DialogLayout.Bottom)
            game.reset()
        }
    }
    if (Level < 10) {
        game.showLongText("Level " + convertToText(Level), DialogLayout.Bottom)
    }
}
...
Level = game.askForNumber("Choose Level 1-9", 1)
Go_to_level(true)
    ...
    if (Driver.y == 16) {
        if (Level < 9) {
            ...
            youwin = sprites.create(img`
                ...
                
